...
/// The main shell for Guardian users with bottom navigation.
/// Contains 3 tabs: Discover, Messages, Dependents (Dashboard)
...
class _GuardianShellState extends State<GuardianShell> {
  ...
  @override
  void didUpdateWidget(GuardianShell oldWidget) {
  ...
  final List<TutorialStep> _tourSteps = [
    TutorialStep(
      title: 'أهلاً بك في ميثاق',
      description: 'تطبيقك الآمن للبحث عن شريك الحياة تحت إشرافك كولي أمر.',
      alignment: Alignment.center,
    ),
    TutorialStep(
      title: 'إدارة التابعين',
      description: 'أضف أبناءك وبناتك وتابع طلباتهم من قسم "التابعين".',
      alignment: Alignment.bottomCenter,
    ),
    TutorialStep(
      title: 'المحادثات',
      description: 'تواصل مع العائلات الأخرى بأمان وخصوصية تامة عبر "الرسائل".',
      alignment: Alignment.bottomCenter,
    ),
  ];
